...
StyledRect {
    ...
    MouseArea {
        ...
        onClicked: event => root.bar.togglePopoutAt(root.mapToItem(root.bar, event.x, event.y).y)
    }
    ...
    ColumnLayout {
        ...
        WrappedLoader {
            ...
            sourceComponent: ColumnLayout {
                ...
                MaterialIcon {
                    ...
                    color: PomodoroTimer.running ? Colours.palette.m3primary : root.colour
                    fill: PomodoroTimer.running ? 1 : 0
                }

                StyledText {
                    Layout.alignment: Qt.AlignHCenter
                    visible: PomodoroTimer.running
                    text: PomodoroTimer.timeText.split(":")[0]
        ...
        WrappedLoader {
            ...
            sourceComponent: ColumnLayout {
                ...
                readonly property bool laptopBattery: UPower.displayDevice.isLaptopBattery
                readonly property bool powerSaverBattery: laptopBattery && UPower.onBattery && UPower.displayDevice.percentage <= 0.3
                readonly property bool lowBattery: laptopBattery && UPower.onBattery && UPower.displayDevice.percentage <= 0.2
                readonly property bool pluggedPerformance: laptopBattery && !UPower.onBattery && PowerProfiles.profile === PowerProfile.Performance
                readonly property color statusColour: lowBattery ? Colours.palette.m3error : powerSaverBattery ? Colours.palette.m3tertiary : pluggedPerformance ? Colours.palette.m3primary : root.colour
                ...
                MaterialIcon {
                    ...
                    color: batteryStatus.statusColour
                    fill: 1

                    SequentialAnimation on opacity {
                        running: batteryStatus.lowBattery
                        loops: Animation.Infinite
                        alwaysRunToEnd: true
                ...
                StyledText {
                    Layout.alignment: Qt.AlignHCenter
                    visible: batteryStatus.laptopBattery
