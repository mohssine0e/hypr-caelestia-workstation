...
GridView {
    ...
    delegate: Item {
        ...
        readonly property bool canDelete: modelData && Wallpapers.isLibraryWallpaper(modelData.path) && !(isCurrent && Wallpapers.list.length <= 1)
        ...
        HoverHandler {
            onHoveredChanged: wallpaperItem.hovered = hovered
        }
        ...
        StyledRect {
            ...
            anchors.bottomMargin: itemMargin
            radius: itemRadius
            color: Qt.alpha(Colours.palette.m3surface, wallpaperItem.hovered ? 0.16 : 0)
            z: 2
        ...
        StyledRect {
            ...
            color: Qt.alpha(Colours.palette.m3errorContainer, 0.92)
            opacity: wallpaperItem.canDelete && wallpaperItem.hovered ? 1 : 0
            ...
            StateLayer {
                ...
                onClicked: Wallpapers.deleteWallpaper(wallpaperItem.modelData.path)
            }
