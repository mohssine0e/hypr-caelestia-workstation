...
Item {
    ...
    Component {
        ...
        Item {
            ...
            readonly property int paneIndex: PaneRegistry.getIndexById("appearance")
            ...
            ColumnLayout {
                ...
                StyledText {
                    ...
                    text: qsTr("No wallpapers found. Add images to the folder above and they will appear here.")
                    color: Colours.palette.m3onSurfaceVariant
                    wrapMode: Text.Wrap
                ...
                Loader {
                    ...
                    asynchronous: true
                    active: {
                        const isActive = root.session.activeIndex === rightAppearanceFlickable.paneIndex;
                        const isAdjacent = Math.abs(root.session.activeIndex - rightAppearanceFlickable.paneIndex) === 1;
