...
Item {
    ...
    Image {
        ...
        opacity: status === Image.Ready ? 0.18 : 0
    ...
    component PlayerControl: StyledRect {
        ...
        color: active ? Colours.palette[`m3${colour.toLowerCase()}`] : Qt.rgba(0, 0, 0, 0.32)
        ...
        StateLayer {
            ...
            color: control.active ? Colours.palette[`m3on${control.colour}`] : Colours.palette.m3onSurface
