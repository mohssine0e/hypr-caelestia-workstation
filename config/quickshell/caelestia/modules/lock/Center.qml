...
ColumnLayout {
    ...
    spacing: Tokens.spacing.large * 1.6
    ...
    StyledRect {
        Layout.alignment: Qt.AlignHCenter
        implicitWidth: kbLayout.implicitWidth + Tokens.padding.normal * 2
        implicitHeight: kbLayout.implicitHeight + Tokens.padding.small * 2
        ...
        RowLayout {
            ...
            StyledText {
                Layout.alignment: Qt.AlignVCenter
                text: Hypr.kbLayout || Hypr.kbLayoutFull || "??"
